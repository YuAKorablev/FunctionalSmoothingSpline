...
if __name__ == '__main__':
    ...
    m = round(3 * len(t_f))
    x = np.arange(t_f[0],38,step = 1)
    x = np.append(x, np.arange(38,46,step = 0.0001))
    x = np.append(x, np.arange(46,t_f[-1], step = 1))
    ...
    # plt.plot(x, r['dy2'], color="magenta")
    ...
    # old_knots = [0, 7.5,  15, 22.5, 30, 37.5, 45, 52.5, 60, 67.5, 75, 82.5, 90, 97.5, 105, 112.5, 120, 127.5, 135, 142.5, 150]
    old_knots = r['knots']
